...
build our <code>_shown</code> and <code>state_</code> class chains in their respective <code>util</code> methods.</p>
...
<p><code>.mobile</code>, <code>.tablet</code>, <code>.desktop</code>, <code>.desktop_wide</code></p>
            ...
            <div class="content"><div class='highlight'><pre>    <span class="hljs-keyword">var</span> sizes = {
        mobile:{min:<span class="hljs-number">0</span>,max:<span class="hljs-number">400</span>},  
        tablet:{min:<span class="hljs-number">401</span>,max:<span class="hljs-number">900</span>},
        desktop:{min:<span class="hljs-number">901</span>,max:<span class="hljs-number">1200</span>},
        desktop_wide:{min:<span class="hljs-number">1201</span>,max:<span class="hljs-number">99999999</span>}
    };</pre></div></div>
...
&gt; <span class="hljs-string">"foo_list_bar foo_of_bar foo_things_bar"</span>
            ...
            csv = csv.replace(<span class="hljs-string">' '</span>,<span class="hljs-string">''</span>);
        ...
        <li id="section-10">
            <div class="annotation">
              ...
              <p><strong>generate <em>shown</em> classes</strong><br><code>util.shown_chain</code></p>
<p>Generate CSS class names for <em>shown</em> elements.</p>
<pre><code>util.shown_chain(<span class="hljs-string">'list,of,things'</span>);
&gt; <span class="hljs-string">'list_shown of_shown things_shown'</span>
</code></pre>
            </div>
...
&gt; <span class="hljs-literal">false</span>
        ...
        <li id="section-15">
            <div class="annotation">
              ...
              <p><strong>test if a state is currently set</strong><br><code>util.is_state</code></p>
...
util.is_state(<span class="hljs-string">'example'</span>);
&gt; <span class="hljs-literal">true</span>
...
<span class="hljs-comment">// &lt;html class=""&gt;</span>
            ...
            <div class="content"><div class='highlight'><pre>        toggle_state: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(csv_state)</span> {</span>
...
<span class="hljs-comment">// &lt;body class="example_shown"&gt;</span>
            ...
            <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> view == <span class="hljs-string">'string'</span>) {
                view = $(<span class="hljs-string">'#'</span>+util.get_namespace(view));
                <span class="hljs-keyword">if</span> (view.length) {
...
less (as in LoC) generated CSS</em></p>
            ...
            <div class="content"><div class='highlight'><pre>        add_state: handlers.add_state,</pre></div></div>
...
// &lt;html class=""&gt;
            ...
            <div class="content"><div class='highlight'><pre>        remove_state: handlers.del_state,</pre></div></div>
...
// &lt;html class=""&gt;
            ...
            <div class="content"><div class='highlight'><pre>        toggle_state: handlers.toggle_state,</pre></div></div>
        ...
        <li id="section-45">
            <div class="annotation">
              ...
              <p><strong>check if a <em>view state</em> is enabled</strong><br><code>MoshPit.is_state</code></p>
<p>Externally accessible means to find out if a
<em>view state</em> is currently active.</p>
<pre><code><span class="hljs-comment">// &lt;html class="state_highlight_all_examples"&gt;</span>
MoshPit.is_state(<span class="hljs-string">"highlight_all_examples"</span>);
&gt; <span class="hljs-literal">true</span>
<span class="hljs-comment">// &lt;html class=""&gt;</span>
MoshPit.is_state(<span class="hljs-string">"highlight_all_examples"</span>);
&gt; <span class="hljs-literal">false</span>
            ...
            <div class="content"><div class='highlight'><pre>        is_state: util.is_state</pre></div></div>
